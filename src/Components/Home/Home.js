    ...
    <div>
      <section>
        <div className="container size-cont">
          ...
          <div>
            <img src={Perfil} className="img-fluid size-round" alt="" />
          </div>
          <div>
            <img src={Compu} className="img-fluid size-compu" alt="" />
          </div>
        </div>
      </section>
      <section className="presentation">
        <div className="container size-cont2">
          ...
          <p>
            Actualmente estoy cursando mi tercer año en la carrera de Ciencias
            de la Computación y TI en la Universidad del Valle de Guatemala. Soy
            una persona autodidacta y por esa razon me gusta ponerme retos y
            aprender nuevas cosas. Además, soy responsable y creo que todo se
            debe de realizar con excelencia. Creo firmemente en que todo en la
            vida se se debe de llevar a cabo con principios.
          </p>
        </div>
